...
module.exports = (adapter) => {
  return {
    ...
    exists: (resourceName, query) => {
      ...
      const key = ['Discovery', resourceName, 'by_query', query];
    ...
    set: (resourceName, query, resource) => {
      ...
      const key = ['Discovery', resourceName, 'by_query', query];
      const dataKey = ['Discovery', resourceName, 'by_query', query, 'data'];
    ...
    get: (resourceName, query) => {
      ...
      const key = ['Discovery', resourceName, 'by_query', query, 'data'];
